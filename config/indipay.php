...
return [
    ...
    */
    ...
    'gateway' => env('PAYMENT_GATEWAY', 'InstaMojo'),                // Replace with the name of default gateway you want to use

    'testMode'  => env('PAYMENT_TEST', true),                   // True for Testing the Gateway [For production false]
    ...
    'ccavenue' => [                         // CCAvenue Parameters
        ...
        'redirectUrl' => env('INDIPAY_REDIRECT_URL', 'payment/response'),
        'cancelUrl' => env('INDIPAY_CANCEL_URL', 'payment/response'),
