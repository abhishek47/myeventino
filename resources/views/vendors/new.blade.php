...
<div id="titlebar" class="submit-page">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2><i class="fa fa-plus-circle"></i> Register As Vendor</h2>
			</div>
		</div>
	</div>
</div>
	...
	<div class="col-md-12">
      ...
      @include('layouts.errors')
		...
		<div class="submit-section">
			...
			<!-- Title -->
			<div class="form">
				<h5>Name <i class="tip" data-tip-content="Type your name or the name of the company that provides the service."></i></h5>
			...
			<div class="row with-forms">
				...
				<div class="col-md-6">
					...
					<select class="chosen-select-no-single" name="vendor_types[]" multiple="true" required="true">
						...
						<option value="play" selected>Photographer</option>
						<option value="conference" selected>Mehendi</option>
                        <option value="workshop" selected>Bride Makeup</option>
				...
				<div class="col-md-6">
					...
					<input name="establishment_date" id="establishment_date" value="{{ old('establishment_date') }}" required="true">
